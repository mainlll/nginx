...
//https://raw.githubusercontent.com/mainlll/nginx/master/backUp/joytoken.json
function readToken() {
  return new Promise(resolve => {
    $.get({url: `https://raw.githubusercontent.com/mainlll/nginx/master/backUp/joytoken.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
...
function getFriendPins() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/mainlll/code/main/share/friendpin.json",
      headers:{
