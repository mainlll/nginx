...
Your old repository’s clone URL 填入 https://github.com/mainlll/nginx ，Your new repository details处填写导入后自己的repository名称，其它按默认，
...
[获取京东Cookies教程](https://github.com/mainlll/code/blob/main/doc/GetJdCookie.md)

环境变量合集（Secrets）配置[点击查看](https://github.com/mainlll/code/blob/main/doc/githubAction.md)
...
>  如何配置,可参考 > [获取京东Cookies教程](https://github.com/mainlll/nginx/blob/master/backUp/GetJdCookie2.md)
>
> 
>   清单(仅供参考）：  
> ##############短期活动############## 
